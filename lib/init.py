...
def has_sucr_conf():
    ...
    #
    # if not, print a message stating that Sucr Core must be installed and
...
def main():
    ...
    if not has_sucr_conf():
        print("SucrCore must be installed and configured, including JSONRPC access in sucr.conf")
        sys.exit(1)
