...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to sucrd "gobject list" output
    ...
    def sucrd_serialise(self):
        import sucrlib
        return sucrlib.SHIM_serialise_for_sucrd(self.serialise())
